...
| Invalid scope | A `404`, or a silent `200` that persists nothing — never a `403` | Check the key with `GET /v1/scopes`, and read back after a write ([gotcha 41](../common-gotchas.md#41-a-write-under-a-read-only-scope-is-a-silent-200)) |
