...
import { parseArgs, stageDocs, TASK, checkAttempt, feedback } from "./trial.mjs";

test("parseArgs: defaults and the four options", () => {
...
test("the staged workspace holds the published documents and not the sample", () => {
