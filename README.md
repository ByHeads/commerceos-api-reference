...
│   │   ├── payment-epi.md        # Build a payment EPI: tutorial, reference and sample
...
- `~orderBy` accepts a single selector; there is no compound sort, and multi-field ordering is rejected with a `400`.
