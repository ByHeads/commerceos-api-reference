...
| [Build a payment EPI](./examples/payment-epi.md) | A payment provider integration: sample server, the call set, setup in CommerceOS, go-live checklist | Sequence diagram, contract reference, conformance fixtures |
