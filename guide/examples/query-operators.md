...
curl -X GET -u ":banana" "example.app.heads.com/api/v1/products~take(10)"

# ~skip(n) - Skip first n results
curl -X GET -u ":banana" "example.app.heads.com/api/v1/products~skip(20)~take(10)"

# ~first - Get first element (NO parentheses!)
curl -X GET -u ":banana" "example.app.heads.com/api/v1/products~first"

# ~last - Get last element (NO parentheses!)
curl -X GET -u ":banana" "example.app.heads.com/api/v1/receipts~last"

# ~count - Count elements (NO parentheses!)
curl -X GET -u ":banana" "example.app.heads.com/api/v1/products~count"
...
curl -X GET -u ":banana" "example.app.heads.com/api/v1/receipts~with(items)/items~flat~take(100)"

# ~orderBy(field) - Sort ascending
curl -X GET -u ":banana" "example.app.heads.com/api/v1/products~orderBy(name)"

# ~orderBy(field:desc) - Sort descending
curl -X GET -u ":banana" "example.app.heads.com/api/v1/products~orderBy(name:desc)"
```
...
curl -X GET -u ":banana" "example.app.heads.com/api/v1/products~just(name,identifiers)"
...
curl -X GET -u ":banana" "example.app.heads.com/api/v1/products~with(prices,categories)"

# ~with nested take
curl -X GET -u ":banana" "example.app.heads.com/api/v1/products~with(prices~take(3))~take(10)"

# ~without(...) - Exclude fields
curl -X GET -u ":banana" "example.app.heads.com/api/v1/agents~without(addresses)"
```
...
curl -X GET -u ":banana" "example.app.heads.com/api/v1/products~where(status=Active)"

# Equality check
curl -X GET -u ":banana" "example.app.heads.com/api/v1/agents~where(@type=person)"

# Not equal
curl -X GET -u ":banana" "example.app.heads.com/api/v1/products~where(status!=Inactive)"

# Pattern match (contains)
curl -X GET -u ":banana" "example.app.heads.com/api/v1/products~where(name=~iPhone)"

# Not contains
curl -X GET -u ":banana" "example.app.heads.com/api/v1/products~where(name!~test)"

# Greater than / less than
curl -X GET -u ":banana" "example.app.heads.com/api/v1/prices~where(amount>100)"
curl -X GET -u ":banana" "example.app.heads.com/api/v1/prices~where(amount<=50)"

# Truthy check (field exists and has value)
curl -X GET -u ":banana" "example.app.heads.com/api/v1/trade-relationships~where(creditAllowed)"

# Falsy check
curl -X GET -u ":banana" "example.app.heads.com/api/v1/products~where(!hidden)"

# Nested path filter
curl -X GET -u ":banana" "example.app.heads.com/api/v1/trade-orders~where(customer/@type=person)"
```
...
curl -X GET -u ":banana" "example.app.heads.com/api/v1/receipts~map(com.heads.receipt-csv)"

# To extract a field from each element, use path navigation:
curl -X GET -u ":banana" "example.app.heads.com/api/v1/products/name"

# To project specific fields, use ~just:
curl -X GET -u ":banana" "example.app.heads.com/api/v1/products~just(name,status)"

# ~typeless - Remove @type annotations (NO parentheses!)
curl -X GET -u ":banana" "example.app.heads.com/api/v1/products~first~typeless"

# ~entries - Convert object to array of {index, key, value}
curl -X GET -u ":banana" "example.app.heads.com/api/v1/agents/com.heads.seedID=ourcompany/addresses~entries"
```
...
curl -X GET -u ":banana" "example.app.heads.com/api/v1/products?status=Active&limit=3"

# Sort and paginate with query params
curl -X GET -u ":banana" "example.app.heads.com/api/v1/products?orderby=name&offset=2&limit=2"

# Sort descending with query params
curl -X GET -u ":banana" "example.app.heads.com/api/v1/products?orderby=name:desc&limit=3"

# Request all fields
curl -X GET -u ":banana" "example.app.heads.com/api/v1/products?fields=all&limit=1"
```
...
curl -X GET -u ":banana" "example.app.heads.com/api/v1/now"

# Generate UUID
curl -X GET -u ":banana" "example.app.heads.com/api/v1/uuid"

# Connection test (returns constant string, not empty)
# Response: "･*★`ﾟ+✧`*ﾟ✦´★･ﾟ✧'*･"
curl -X GET -u ":banana" "example.app.heads.com/api/v1/void"
```
...
curl -X GET -u ":banana" "example.app.heads.com/api/v1/elements/types"

# Get all properties across all types
curl -X GET -u ":banana" "example.app.heads.com/api/v1/elements/properties"

# Get all methods across all types
curl -X GET -u ":banana" "example.app.heads.com/api/v1/elements/methods"
```
...
curl -X GET -u ":banana" "example.app.heads.com/api" -H "Accept: application/json"

# Get OpenAPI specification (YAML)
curl -X GET -u ":banana" "example.app.heads.com/api" -H "Accept: application/yaml"
```
