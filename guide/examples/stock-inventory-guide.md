...
curl -X GET -u ":banana" "localhost:5000/api/v1/stocks"
```
...
curl -X POST -u ":banana" "localhost:5000/api/v1/stocks" \
...
curl -X GET -u ":banana" "localhost:5000/api/v1/stocks/com.example.id=consignment-stock"

# Update a stock name
curl -X PATCH -u ":banana" "localhost:5000/api/v1/stocks/com.example.id=consignment-stock" \
  -H "Content-Type: application/json" \
...
curl -X POST -u ":banana" "localhost:5000/api/v1/stores/com.example.storeId=stockholm/stockRoots" \
  -H "Content-Type: application/json" \
...
curl -X GET -u ":banana" "localhost:5000/api/v1/stock-places/com.example.id=stockholm-store/identifiers/key"
...
curl -X GET -u ":banana" "localhost:5000/api/v1/stock-places/com.example.id=stockholm-store~with(children)"

# Update a stock place name
curl -X PATCH -u ":banana" "localhost:5000/api/v1/stock-places/com.example.id=stockholm-store" \
  -H "Content-Type: application/json" \
...
curl -X PUT -u ":banana" "localhost:5000/api/v1/stores/com.example.storeId=stockholm/stockRoots" \
  -H "Content-Type: application/json" \
  -d '[]'
```
...
curl -X GET -u ":banana" "localhost:5000/api/v1/stock-adjustment-reasons/com.example.id=restock"

# Deactivate a reason (soft-disable, doesn't delete it)
curl -X PATCH -u ":banana" "localhost:5000/api/v1/stock-adjustment-reasons/com.example.id=stolen" \
  -H "Content-Type: application/json" \
  -d '{ "active": false }'
```
...
curl -X GET -u ":banana" "localhost:5000/api/v1/products/com.example.sku=TSHIRT-RED-M/stockLevels"
```
...
curl -X GET -u ":banana" "localhost:5000/api/v1/stock-adjustments/com.example.id=adj-restock-001~with(items)"

# Get all stock transactions (adjustments) for a specific stock place
curl -X GET -u ":banana" "localhost:5000/api/v1/stock-places/com.example.id=stockholm-store/transactions"

# Get individual adjustment items for a specific stock place
curl -X GET -u ":banana" "localhost:5000/api/v1/stock-places/com.example.id=stockholm-store/transactionItems"
```
...
curl -X GET -u ":banana" "localhost:5000/api/v1/stock-adjustment-items"
```
...
curl -X POST -u ":banana" "localhost:5000/api/v1/stock-counts" \
  -H "Content-Type: application/json" \
  -d '{
...
curl -X POST -u ":banana" "localhost:5000/api/v1/stock-count-items" \
  -H "Content-Type: application/json" \
  -d '{
...
curl -X POST -u ":banana" "localhost:5000/api/v1/stock-count-observations" \
  -H "Content-Type: application/json" \
  -d '{
...
curl -X GET -u ":banana" "localhost:5000/api/v1/stock-counts/com.example.id=count-2026-q1~with(items~with(observations))"
```
...
curl -X GET -u ":banana" "localhost:5000/api/v1/stock-counts/com.example.id=count-2026-q1~just(identifiers,status)"
```
...
curl -X GET -u ":banana" "localhost:5000/api/v1/stock-count-records"

# Get a specific stock count record with items
curl -X GET -u ":banana" "localhost:5000/api/v1/stock-count-records/key=abc123~with(items)"

# Get stock count records for a specific stock count
curl -X GET -u ":banana" "localhost:5000/api/v1/stock-counts/com.example.id=count-2026-q1/records~with(items)"
```
...
curl -X POST -u ":banana" "localhost:5000/api/v1/stock-transfer-items" \
  -H "Content-Type: application/json" \
  -d '{
...
curl -X PATCH -u ":banana" "localhost:5000/api/v1/stock-transfers/com.example.id=transfer-001" \
  -H "Content-Type: application/json" \
...
curl -X GET -u ":banana" "localhost:5000/api/v1/stock-transfers/com.example.id=transfer-001~just(identifiers,status)"
```
...
curl -X GET -u ":banana" "localhost:5000/api/v1/stock-transfers/com.example.id=transfer-001~with(items)"
```
...
curl -X GET -u ":banana" "localhost:5000/api/v1/stock-transfer-records"

# Get a specific record with items and their actions
curl -X GET -u ":banana" "localhost:5000/api/v1/stock-transfer-records/key=abc123~with(items~with(actions))"

# Get records for a specific transfer
curl -X GET -u ":banana" "localhost:5000/api/v1/stock-transfers/com.example.id=transfer-001/records~with(items~with(actions))"
```
...
curl -X PATCH -u ":banana" "localhost:5000/api/v1/products/com.example.sku=IPHONE-15-128" \
  -H "Content-Type: application/json" \
  -d '{
    "tracking": {
...
curl -X PATCH -u ":banana" "localhost:5000/api/v1/products/com.example.sku=MILK-WHOLE-1L" \
  -H "Content-Type: application/json" \
  -d '{
    "tracking": {
...
curl -X PATCH -u ":banana" "localhost:5000/api/v1/stock-transfers/com.example.id=transfer-phone-001" \
  -H "Content-Type: application/json" \
  -d '{ "actions": { "tryFulfill": true } }'
```
...
curl -X GET -u ":banana" "localhost:5000/api/v1/stock-transfers/com.example.id=transfer-phone-001/records~with(items~with(actions))"
```
...
curl -X POST -u ":banana" "localhost:5000/api/v1/stores/com.example.storeId=gothenburg/stockRoots" \
  -H "Content-Type: application/json" \
...
curl -X GET -u ":banana" "localhost:5000/api/v1/stock-places/com.example.id=store-stockholm/entries"
```
...
curl -X GET -u ":banana" "localhost:5000/api/v1/stock-places/com.example.id=store-stockholm/transactions~with(items)"

# Get individual adjustment items for detailed reconciliation
curl -X GET -u ":banana" "localhost:5000/api/v1/stock-places/com.example.id=store-stockholm/transactionItems"
```
...
curl -X GET -u ":banana" "localhost:5000/api/v1/products/com.example.sku=TSHIRT-RED-M/designatedStockPlaces"
```
